...
GO
INSERT sys_menu VALUES (4, N'流程管理', 0, 5, N'process', NULL, N'', 1, 0, N'M', N'0', N'0', N'', N'skill', 103, 1, getdate(), NULL, NULL, N'流程管理目录')
GO
INSERT sys_menu VALUES (5, N'办公管理', 0, 6, N'work', NULL, N'', 1, 0, N'M', N'0', N'0', N'', N'job', 103, 1, getdate(), NULL, NULL, N'办公管理目录')
GO
...
GO
INSERT sys_menu VALUES (110, N'缓存监控', 2, 5, N'cache', N'monitor/cache/index', N'', 1, 0, N'C', N'0', N'0', N'monitor:cache:list', N'redis', 103, 1, getdate(), NULL, NULL, N'缓存监控菜单')
GO
INSERT sys_menu VALUES (111, N'表单构建', 3, 1, N'build', N'tool/build/index', N'', 1, 0, N'C', N'0', N'0', N'tool:build:list', N'build', 103, 1, getdate(), NULL, NULL, N'表单构建菜单')
GO
INSERT sys_menu VALUES (112, N'代码生成', 3, 2, N'gen', N'tool/gen/index', N'', 1, 0, N'C', N'0', N'0', N'tool:gen:list', N'code', 103, 1, getdate(), NULL, NULL, N'代码生成菜单')
GO
INSERT sys_menu VALUES (113, N'租户管理', 6, 1, N'tenant', N'system/tenant/index', N'', 1, 0, N'C', N'0', N'0', N'system:tenant:list', N'code', 103, 1, getdate(), NULL, NULL, N'租户管理菜单')
GO
INSERT sys_menu VALUES (114, N'租户套餐管理', 6, 2, N'tenantPackage', N'system/tenantPackage/index', N'', 1, 0, N'C', N'0', N'0', N'system:tenantPackage:list', N'code', 103, 1, getdate(), NULL, NULL, N'租户套餐管理菜单')
GO
...
GO
INSERT sys_menu VALUES (119, N'任务调度中心', 2, 5, N'XxlJob', N'monitor/xxljob/index', N'', 1, 0, N'C', N'0', N'0', N'monitor:xxljob:list', N'job', 103, 1, getdate(), NULL, NULL, N'Xxl-Job控制台菜单');
GO
INSERT sys_menu VALUES (121,  N'流程分类', 4, 1, N'category', N'workflow/category/index', N'', 1, 0, N'C', N'0', N'0', N'workflow:category:list', N'nested', 103, 1, getdate(), NULL, NULL, N'流程分类菜单')
GO
INSERT sys_menu VALUES (122,  N'表单配置', 4, 2, N'form', N'workflow/form/index', N'', 1, 0, N'C', N'0', N'0', N'workflow:form:list', N'form', 103, 1, getdate(), NULL, NULL, N'表单配置菜单')
GO
INSERT sys_menu VALUES (123,  N'流程模型', 4, 3, N'model', N'workflow/model/index', N'', 1, 0, N'C', N'0', N'0', N'workflow:model:list', N'component', 103, 1, getdate(), NULL, NULL, N'流程模型菜单')
GO
INSERT sys_menu VALUES (124,  N'部署管理', 4, 4, N'deploy', N'workflow/deploy/index', N'', 1, 0, N'C', N'0', N'0', N'workflow:deploy:list', N'example', 103, 1, getdate(), NULL, NULL, N'部署管理菜单')
GO
INSERT sys_menu VALUES (125,  N'新建流程', 5, 1, N'create', N'workflow/work/index', N'', 1, 0, N'C', N'0', N'0', N'workflow:process:startList', N'guide', 103, 1, getdate(), NULL, NULL, N'新建流程菜单')
GO
INSERT sys_menu VALUES (126,  N'我的流程', 5, 2, N'own', N'workflow/work/own', N'', 1, 0, N'C', N'0', N'0', N'workflow:process:ownList', N'cascader', 103, 1, getdate(), NULL, NULL, N'我的流程菜单')
GO
INSERT sys_menu VALUES (127,  N'待办任务', 5, 3, N'todo', N'workflow/work/todo', N'', 1, 0, N'C', N'0', N'0', N'workflow:process:todoList', N'time-range', 103, 1, getdate(), NULL, NULL, N'待办任务菜单')
GO
INSERT sys_menu VALUES (128,  N'待签任务', 5, 4, N'claim', N'workflow/work/claim', N'', 1, 0, N'C', N'0', N'0', N'workflow:process:claimList', N'checkbox', 103, 1, getdate(), NULL, NULL, N'待签任务菜单')
GO
INSERT sys_menu VALUES (129,  N'已办任务', 5, 5, N'finished', N'workflow/work/finished', N'', 1, 0, N'C', N'0', N'0', N'workflow:process:finishedList', N'checkbox', 103, 1, getdate(), NULL, NULL, N'已办任务菜单')
GO
INSERT sys_menu VALUES (130,  N'抄送我的', 5, 6, N'copy', N'workflow/work/copy', N'', 1, 0, N'C', N'0', N'0', N'workflow:process:copyList', N'checkbox', 103, 1, getdate(), NULL, NULL, N'抄送我的菜单')
GO
...
GO
INSERT sys_menu VALUES (1010, N'角色查询', 101, 1, N'', N'', N'', 1, 0, N'F', N'0', N'0', N'system:role:query', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1011, N'角色新增', 101, 2, N'', N'', N'', 1, 0, N'F', N'0', N'0', N'system:role:add', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1012, N'角色修改', 101, 3, N'', N'', N'', 1, 0, N'F', N'0', N'0', N'system:role:edit', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1013, N'角色删除', 101, 4, N'', N'', N'', 1, 0, N'F', N'0', N'0', N'system:role:remove', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1014, N'角色导出', 101, 5, N'', N'', N'', 1, 0, N'F', N'0', N'0', N'system:role:export', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1020, N'菜单查询', 102, 1, N'', N'', N'', 1, 0, N'F', N'0', N'0', N'system:menu:query', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1021, N'菜单新增', 102, 2, N'', N'', N'', 1, 0, N'F', N'0', N'0', N'system:menu:add', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1022, N'菜单修改', 102, 3, N'', N'', N'', 1, 0, N'F', N'0', N'0', N'system:menu:edit', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1023, N'菜单删除', 102, 4, N'', N'', N'', 1, 0, N'F', N'0', N'0', N'system:menu:remove', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1030, N'部门查询', 103, 1, N'', N'', N'', 1, 0, N'F', N'0', N'0', N'system:dept:query', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1031, N'部门新增', 103, 2, N'', N'', N'', 1, 0, N'F', N'0', N'0', N'system:dept:add', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1032, N'部门修改', 103, 3, N'', N'', N'', 1, 0, N'F', N'0', N'0', N'system:dept:edit', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1033, N'部门删除', 103, 4, N'', N'', N'', 1, 0, N'F', N'0', N'0', N'system:dept:remove', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1040, N'岗位查询', 104, 1, N'', N'', N'', 1, 0, N'F', N'0', N'0', N'system:post:query', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1041, N'岗位新增', 104, 2, N'', N'', N'', 1, 0, N'F', N'0', N'0', N'system:post:add', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1042, N'岗位修改', 104, 3, N'', N'', N'', 1, 0, N'F', N'0', N'0', N'system:post:edit', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1043, N'岗位删除', 104, 4, N'', N'', N'', 1, 0, N'F', N'0', N'0', N'system:post:remove', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1044, N'岗位导出', 104, 5, N'', N'', N'', 1, 0, N'F', N'0', N'0', N'system:post:export', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1050, N'字典查询', 105, 1, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'system:dict:query', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1051, N'字典新增', 105, 2, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'system:dict:add', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1052, N'字典修改', 105, 3, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'system:dict:edit', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1053, N'字典删除', 105, 4, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'system:dict:remove', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1054, N'字典导出', 105, 5, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'system:dict:export', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1060, N'参数查询', 106, 1, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'system:config:query', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1061, N'参数新增', 106, 2, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'system:config:add', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1062, N'参数修改', 106, 3, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'system:config:edit', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1063, N'参数删除', 106, 4, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'system:config:remove', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1064, N'参数导出', 106, 5, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'system:config:export', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1070, N'公告查询', 107, 1, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'system:notice:query', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1071, N'公告新增', 107, 2, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'system:notice:add', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1072, N'公告修改', 107, 3, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'system:notice:edit', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1073, N'公告删除', 107, 4, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'system:notice:remove', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1080, N'操作查询', 500, 1, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'monitor:operlog:query', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1081, N'操作删除', 500, 2, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'monitor:operlog:remove', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1082, N'日志导出', 500, 4, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'monitor:operlog:export', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1090, N'登录查询', 501, 1, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'monitor:logininfor:query', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1091, N'登录删除', 501, 2, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'monitor:logininfor:remove', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1092, N'日志导出', 501, 3, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'monitor:logininfor:export', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1093, N'账户解锁', 501, 4, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'monitor:logininfor:unlock',  N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1100, N'在线查询', 109, 1, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'monitor:online:query', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1101, N'批量强退', 109, 2, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'monitor:online:batchLogout', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1102, N'单条强退', 109, 3, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'monitor:online:forceLogout', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1120, N'生成查询', 115, 1, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'tool:gen:query', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1121, N'生成修改', 115, 2, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'tool:gen:edit', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1122, N'生成删除', 115, 3, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'tool:gen:remove', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1123, N'导入代码', 115, 2, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'tool:gen:import', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1124, N'预览代码', 115, 4, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'tool:gen:preview', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1125, N'生成代码', 115, 5, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'tool:gen:code', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
-- oss相关按钮
INSERT sys_menu VALUES (1130, N'文件查询', 118, 1, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'system:oss:query', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1131, N'文件上传', 118, 2, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'system:oss:upload', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1132, N'文件下载', 118, 3, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'system:oss:download', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1133, N'文件删除', 118, 4, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'system:oss:remove', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1134, N'配置添加', 118, 5, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'system:oss:add', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1135, N'配置编辑', 118, 6, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'system:oss:edit', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
-- 租户管理相关按钮
INSERT sys_menu VALUES (1606, N'租户查询', 113, 1, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'system:tenant:query', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1607, N'租户新增', 113, 2, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'system:tenant:add', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1608, N'租户修改', 113, 3, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'system:tenant:edit', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1609, N'租户删除', 113, 4, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'system:tenant:remove', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1610, N'租户导出', 113, 5, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'system:tenant:export', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
-- 租户套餐管理相关按钮
INSERT sys_menu VALUES (1611, N'租户套餐查询', 114, 1, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'system:tenantPackage:query', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1612, N'租户套餐新增', 114, 2, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'system:tenantPackage:add', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1613, N'租户套餐修改', 114, 3, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'system:tenantPackage:edit', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1614, N'租户套餐删除', 114, 4, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'system:tenantPackage:remove', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1615, N'租户套餐导出', 114, 5, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'system:tenantPackage:export', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
-- 流程分类管理
INSERT sys_menu VALUES (1140, N'分类查询', 121, 1, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'workflow:category:query', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1141, N'分类新增', 121, 2, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'workflow:category:add', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1142, N'分类编辑', 121, 3, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'workflow:category:edit', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1143, N'分类删除', 121, 4, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'workflow:category:remove', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
-- 表单配置
INSERT sys_menu VALUES (1150, N'表单查询', 122, 1, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'workflow:form:query', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1151, N'表单新增', 122, 2, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'workflow:form:add', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1152, N'表单修改', 122, 3, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'workflow:form:edit', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1153, N'表单删除', 122, 4, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'workflow:form:remove', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1154, N'表单导出', 122, 5, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'workflow:form:export', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
-- 流程定义
INSERT sys_menu VALUES (1160, N'模型查询', 123, 1, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'workflow:model:query', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1161, N'模型新增', 123, 2, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'workflow:model:add', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1162, N'模型修改', 123, 3, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'workflow:model:edit', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1163, N'模型删除', 123, 4, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'workflow:model:remove', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1164, N'模型导出', 123, 5, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'workflow:model:export', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1165, N'模型导入', 123, 6, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'workflow:model:import', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1166, N'模型设计', 123, 7, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'workflow:model:designer', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1167, N'模型保存', 123, 8, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'workflow:model:save', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1168, N'流程部署', 123, 9, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'workflow:model:deploy', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
-- 部署管理
INSERT sys_menu VALUES (1170, N'部署查询', 124, 1, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'workflow:deploy:query', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1171, N'部署删除', 124, 2, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'workflow:deploy:remove', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1172, N'更新状态', 124, 3, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'workflow:deploy:status', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
-- 新建流程
INSERT sys_menu VALUES (1180, N'发起流程', 125, 1, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'workflow:process:start', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1181, N'新建流程导出', 125, 2, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'workflow:process:startExport', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
-- 我的流程
INSERT sys_menu VALUES (1190, N'流程详情', 126, 1, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'workflow:process:query', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1191, N'流程删除', 126, 2, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'workflow:process:remove', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1192, N'流程取消', 126, 3, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'workflow:process:cancel', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1193, N'我的流程导出', 126, 4, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'workflow:process:ownExport', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
-- 待办任务
INSERT sys_menu VALUES (1200, N'流程办理', 127, 1, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'workflow:process:approval', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1201, N'待办流程导出', 127, 2, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'workflow:process:todoExport', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
-- 待签任务
INSERT sys_menu VALUES (1210, N'流程签收', 128, 1, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'workflow:process:claim', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1211, N'待签流程导出', 128, 2, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'workflow:process:claimExport', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
-- 已办任务
INSERT sys_menu VALUES (1220, N'流程撤回', 129, 1, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'workflow:process:revoke', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
INSERT sys_menu VALUES (1221, N'流程撤回', 129, 2, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'workflow:process:finishedExport', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
-- 抄送我的
INSERT sys_menu VALUES (1230, N'抄送流程导出', 130, 1, N'#', N'', N'', 1, 0, N'F', N'0', N'0', N'workflow:process:copyExport', N'#', 103, 1, getdate(), NULL, NULL, N'')
GO
...
GO
INSERT sys_role_menu VALUES (2, 4)
GO
INSERT sys_role_menu VALUES (2, 5)
GO
INSERT sys_role_menu VALUES (2, 6)
GO
...
GO
INSERT sys_role_menu VALUES (2, 117)
GO
INSERT sys_role_menu VALUES (2, 118)
GO
INSERT sys_role_menu VALUES (2, 119)
GO
INSERT sys_role_menu VALUES (2, 121)
GO
INSERT sys_role_menu VALUES (2, 122)
GO
INSERT sys_role_menu VALUES (2, 123)
GO
INSERT sys_role_menu VALUES (2, 124)
GO
INSERT sys_role_menu VALUES (2, 125)
GO
INSERT sys_role_menu VALUES (2, 126)
GO
INSERT sys_role_menu VALUES (2, 127)
GO
INSERT sys_role_menu VALUES (2, 128)
GO
INSERT sys_role_menu VALUES (2, 129)
GO
INSERT sys_role_menu VALUES (2, 130)
GO
...
GO
INSERT sys_role_menu VALUES (2, 1070)
GO
INSERT sys_role_menu VALUES (2, 1071)
GO
INSERT sys_role_menu VALUES (2, 1072)
GO
INSERT sys_role_menu VALUES (2, 1073)
GO
INSERT sys_role_menu VALUES (2, 1080)
GO
INSERT sys_role_menu VALUES (2, 1081)
GO
INSERT sys_role_menu VALUES (2, 1082)
GO
INSERT sys_role_menu VALUES (2, 1090)
GO
INSERT sys_role_menu VALUES (2, 1091)
GO
INSERT sys_role_menu VALUES (2, 1092)
GO
INSERT sys_role_menu VALUES (2, 1093)
GO
INSERT sys_role_menu VALUES (2, 1100)
GO
INSERT sys_role_menu VALUES (2, 1101)
GO
INSERT sys_role_menu VALUES (2, 1102)
GO
INSERT sys_role_menu VALUES (2, 1120)
GO
INSERT sys_role_menu VALUES (2, 1121)
GO
INSERT sys_role_menu VALUES (2, 1122)
GO
INSERT sys_role_menu VALUES (2, 1123)
GO
INSERT sys_role_menu VALUES (2, 1124)
GO
INSERT sys_role_menu VALUES (2, 1125)
GO
INSERT sys_role_menu VALUES (2, 1130)
GO
INSERT sys_role_menu VALUES (2, 1131)
GO
INSERT sys_role_menu VALUES (2, 1132)
GO
INSERT sys_role_menu VALUES (2, 1133)
GO
INSERT sys_role_menu VALUES (2, 1134)
GO
INSERT sys_role_menu VALUES (2, 1135)
GO
INSERT sys_role_menu VALUES (2, 1140)
GO
INSERT sys_role_menu VALUES (2, 1141)
GO
INSERT sys_role_menu VALUES (2, 1142)
GO
INSERT sys_role_menu VALUES (2, 1143)
GO
INSERT sys_role_menu VALUES (2, 1150)
GO
INSERT sys_role_menu VALUES (2, 1151)
GO
INSERT sys_role_menu VALUES (2, 1152)
GO
INSERT sys_role_menu VALUES (2, 1153)
GO
INSERT sys_role_menu VALUES (2, 1154)
GO
INSERT sys_role_menu VALUES (2, 1160)
GO
INSERT sys_role_menu VALUES (2, 1161)
GO
INSERT sys_role_menu VALUES (2, 1162)
GO
INSERT sys_role_menu VALUES (2, 1163)
GO
INSERT sys_role_menu VALUES (2, 1164)
GO
INSERT sys_role_menu VALUES (2, 1165)
GO
INSERT sys_role_menu VALUES (2, 1166)
GO
INSERT sys_role_menu VALUES (2, 1167)
GO
INSERT sys_role_menu VALUES (2, 1168)
GO
INSERT sys_role_menu VALUES (2, 1170)
GO
INSERT sys_role_menu VALUES (2, 1171)
GO
INSERT sys_role_menu VALUES (2, 1172)
GO
INSERT sys_role_menu VALUES (2, 1180)
GO
INSERT sys_role_menu VALUES (2, 1181)
GO
INSERT sys_role_menu VALUES (2, 1190)
GO
INSERT sys_role_menu VALUES (2, 1191)
GO
INSERT sys_role_menu VALUES (2, 1192)
GO
INSERT sys_role_menu VALUES (2, 1193)
GO
INSERT sys_role_menu VALUES (2, 1200)
GO
INSERT sys_role_menu VALUES (2, 1201)
GO
INSERT sys_role_menu VALUES (2, 1210)
GO
INSERT sys_role_menu VALUES (2, 1211)
GO
INSERT sys_role_menu VALUES (2, 1220)
GO
INSERT sys_role_menu VALUES (2, 1221)
GO
INSERT sys_role_menu VALUES (2, 1230)
GO
INSERT sys_role_menu VALUES (2, 1606)
GO
INSERT sys_role_menu VALUES (2, 1607)
GO
INSERT sys_role_menu VALUES (2, 1608)
GO
INSERT sys_role_menu VALUES (2, 1609)
GO
INSERT sys_role_menu VALUES (2, 1610)
GO
INSERT sys_role_menu VALUES (2, 1611)
GO
INSERT sys_role_menu VALUES (2, 1612)
GO
INSERT sys_role_menu VALUES (2, 1613)
GO
INSERT sys_role_menu VALUES (2, 1614)
GO
INSERT sys_role_menu VALUES (2, 1615)
GO
