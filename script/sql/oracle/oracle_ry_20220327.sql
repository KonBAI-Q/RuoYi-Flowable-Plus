...
insert into sys_menu values('5', '流程管理', '0', '4', 'workflow',         null, '', 1, 0, 'M', '0', '0', '', 'skill',    'admin', sysdate, '', null, '流程管理目录');
insert into sys_menu values('6', '任务管理', '0', '5', 'task',             null, '', 1, 0, 'M', '0', '0', '', 'job',      'admin', sysdate, '', null, '任务管理目录');
