...
insert into sys_menu values('4', '流程管理', '0', '5', 'process',          null, '', '1', '0', 'M', '0', '0', '', 'skill',    103, 1, now(), null, null, '流程管理目录');
insert into sys_menu values('5', '办公管理', '0', '6', 'work',             null, '', '1', '0', 'M', '0', '0', '', 'job',      103, 1, now(), null, null, '办公管理目录');
...
insert into sys_menu values('110',  '缓存监控',     '2',   '5', 'cache',            'monitor/cache/index',          '', '1', '0', 'C', '0', '0', 'monitor:cache:list',          'redis',         103, 1, now(), null, null, '缓存监控菜单');
insert into sys_menu values('111',  '表单构建',     '3',   '1', 'build',            'tool/build/index',             '', '1', '0', 'C', '0', '0', 'tool:build:list',             'build',         103, 1, now(), null, null, '表单构建菜单');
insert into sys_menu values('112',  '代码生成',     '3',   '2', 'gen',              'tool/gen/index',               '', '1', '0', 'C', '0', '0', 'tool:gen:list',               'code',          103, 1, now(), null, null, '代码生成菜单');
insert into sys_menu values('113', '租户管理',     '6',   '1', 'tenant',           'system/tenant/index',          '', '1', '0', 'C', '0', '0', 'system:tenant:list',          'list',          103, 1, now(), null, null, '租户管理菜单');
insert into sys_menu values('114', '租户套餐管理',  '6',   '2', 'tenantPackage',    'system/tenantPackage/index',   '', '1', '0', 'C', '0', '0', 'system:tenantPackage:list',   'form',          103, 1, now(), null, null, '租户套餐管理菜单');
...
-- xxl-job-admin控制台
insert into sys_menu values('119',  '任务调度中心',  '2',   '5',  'XxlJob',           'monitor/xxljob/index',        '', '1', '0', 'C', '0', '0', 'monitor:xxljob:list',          'job',           103, 1, now(), null, null, 'Xxl-Job控制台菜单');
-- 流程管理
insert into sys_menu values('121',  '流程分类',     '4',   '1', 'category',          'workflow/category/index',      '', '1', '0', 'C', '0', '0', 'workflow:category:list',   'nested',       103, 1, now(), null, null, '流程分类菜单');
insert into sys_menu values('122',  '表单配置',     '4',   '2', 'form',              'workflow/form/index',          '', '1', '0', 'C', '0', '0', 'workflow:form:list',       'form',         103, 1, now(), null, null, '表单配置菜单');
insert into sys_menu values('123',  '流程模型',     '4',   '3', 'model',             'workflow/model/index',         '', '1', '0', 'C', '0', '0', 'workflow:model:list',      'component',    103, 1, now(), null, null, '流程模型菜单');
insert into sys_menu values('124',  '部署管理',     '4',   '4', 'deploy',            'workflow/deploy/index',        '', '1', '0', 'C', '0', '0', 'workflow:deploy:list',     'example',      103, 1, now(), null, null, '部署管理菜单');
-- 办公管理
insert into sys_menu values('125',  '新建流程',     '5',   '1', 'create',            'workflow/work/index',       '', '1', '0', 'C', '0', '0', 'workflow:process:startList',    'guide',      103, 1, now(), null, null, '新建流程菜单');
insert into sys_menu values('126',  '我的流程',     '5',   '2', 'own',               'workflow/work/own',         '', '1', '0', 'C', '0', '0', 'workflow:process:ownList',      'cascader',   103, 1, now(), null, null, '我的流程菜单');
insert into sys_menu values('127',  '待办任务',     '5',   '3', 'todo',              'workflow/work/todo',        '', '1', '0', 'C', '0', '0', 'workflow:process:todoList',     'time-range', 103, 1, now(), null, null, '待办任务菜单');
insert into sys_menu values('128',  '待签任务',     '5',   '4', 'claim',             'workflow/work/claim',       '', '1', '0', 'C', '0', '0', 'workflow:process:claimList',    'checkbox',   103, 1, now(), null, null, '待签任务菜单');
insert into sys_menu values('129',  '已办任务',     '5',   '5', 'finished',          'workflow/work/finished',    '', '1', '0', 'C', '0', '0', 'workflow:process:finishedList', 'checkbox',   103, 1, now(), null, null, '已办任务菜单');
insert into sys_menu values('130',  '抄送我的',     '5',   '6', 'copy',              'workflow/work/copy',        '', '1', '0', 'C', '0', '0', 'workflow:process:copyList',     'checkbox',   103, 1, now(), null, null, '抄送我的菜单');
...
-- 角色管理按钮
insert into sys_menu values('1010', '角色查询', '101', '1',  '', '', '', '1', '0', 'F', '0', '0', 'system:role:query',          '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1011', '角色新增', '101', '2',  '', '', '', '1', '0', 'F', '0', '0', 'system:role:add',            '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1012', '角色修改', '101', '3',  '', '', '', '1', '0', 'F', '0', '0', 'system:role:edit',           '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1013', '角色删除', '101', '4',  '', '', '', '1', '0', 'F', '0', '0', 'system:role:remove',         '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1014', '角色导出', '101', '5',  '', '', '', '1', '0', 'F', '0', '0', 'system:role:export',         '#', 103, 1, now(), null, null, '');
-- 菜单管理按钮
insert into sys_menu values('1020', '菜单查询', '102', '1',  '', '', '', '1', '0', 'F', '0', '0', 'system:menu:query',          '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1021', '菜单新增', '102', '2',  '', '', '', '1', '0', 'F', '0', '0', 'system:menu:add',            '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1022', '菜单修改', '102', '3',  '', '', '', '1', '0', 'F', '0', '0', 'system:menu:edit',           '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1023', '菜单删除', '102', '4',  '', '', '', '1', '0', 'F', '0', '0', 'system:menu:remove',         '#', 103, 1, now(), null, null, '');
-- 部门管理按钮
insert into sys_menu values('1030', '部门查询', '103', '1',  '', '', '', '1', '0', 'F', '0', '0', 'system:dept:query',          '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1031', '部门新增', '103', '2',  '', '', '', '1', '0', 'F', '0', '0', 'system:dept:add',            '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1032', '部门修改', '103', '3',  '', '', '', '1', '0', 'F', '0', '0', 'system:dept:edit',           '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1033', '部门删除', '103', '4',  '', '', '', '1', '0', 'F', '0', '0', 'system:dept:remove',         '#', 103, 1, now(), null, null, '');
-- 岗位管理按钮
insert into sys_menu values('1040', '岗位查询', '104', '1',  '', '', '', '1', '0', 'F', '0', '0', 'system:post:query',          '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1041', '岗位新增', '104', '2',  '', '', '', '1', '0', 'F', '0', '0', 'system:post:add',            '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1042', '岗位修改', '104', '3',  '', '', '', '1', '0', 'F', '0', '0', 'system:post:edit',           '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1043', '岗位删除', '104', '4',  '', '', '', '1', '0', 'F', '0', '0', 'system:post:remove',         '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1044', '岗位导出', '104', '5',  '', '', '', '1', '0', 'F', '0', '0', 'system:post:export',         '#', 103, 1, now(), null, null, '');
-- 字典管理按钮
insert into sys_menu values('1050', '字典查询', '105', '1', '#', '', '', '1', '0', 'F', '0', '0', 'system:dict:query',          '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1051', '字典新增', '105', '2', '#', '', '', '1', '0', 'F', '0', '0', 'system:dict:add',            '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1052', '字典修改', '105', '3', '#', '', '', '1', '0', 'F', '0', '0', 'system:dict:edit',           '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1053', '字典删除', '105', '4', '#', '', '', '1', '0', 'F', '0', '0', 'system:dict:remove',         '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1054', '字典导出', '105', '5', '#', '', '', '1', '0', 'F', '0', '0', 'system:dict:export',         '#', 103, 1, now(), null, null, '');
-- 参数设置按钮
insert into sys_menu values('1060', '参数查询', '106', '1', '#', '', '', '1', '0', 'F', '0', '0', 'system:config:query',        '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1061', '参数新增', '106', '2', '#', '', '', '1', '0', 'F', '0', '0', 'system:config:add',          '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1062', '参数修改', '106', '3', '#', '', '', '1', '0', 'F', '0', '0', 'system:config:edit',         '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1063', '参数删除', '106', '4', '#', '', '', '1', '0', 'F', '0', '0', 'system:config:remove',       '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1064', '参数导出', '106', '5', '#', '', '', '1', '0', 'F', '0', '0', 'system:config:export',       '#', 103, 1, now(), null, null, '');
-- 通知公告按钮
insert into sys_menu values('1070', '公告查询', '107', '1', '#', '', '', '1', '0', 'F', '0', '0', 'system:notice:query',        '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1071', '公告新增', '107', '2', '#', '', '', '1', '0', 'F', '0', '0', 'system:notice:add',          '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1072', '公告修改', '107', '3', '#', '', '', '1', '0', 'F', '0', '0', 'system:notice:edit',         '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1073', '公告删除', '107', '4', '#', '', '', '1', '0', 'F', '0', '0', 'system:notice:remove',       '#', 103, 1, now(), null, null, '');
-- 操作日志按钮
insert into sys_menu values('1080', '操作查询', '500', '1', '#', '', '', '1', '0', 'F', '0', '0', 'monitor:operlog:query',      '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1081', '操作删除', '500', '2', '#', '', '', '1', '0', 'F', '0', '0', 'monitor:operlog:remove',     '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1082', '日志导出', '500', '4', '#', '', '', '1', '0', 'F', '0', '0', 'monitor:operlog:export',     '#', 103, 1, now(), null, null, '');
-- 登录日志按钮
insert into sys_menu values('1090', '登录查询', '501', '1', '#', '', '', '1', '0', 'F', '0', '0', 'monitor:logininfor:query',   '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1091', '登录删除', '501', '2', '#', '', '', '1', '0', 'F', '0', '0', 'monitor:logininfor:remove',  '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1092', '日志导出', '501', '3', '#', '', '', '1', '0', 'F', '0', '0', 'monitor:logininfor:export',  '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1093', '账户解锁', '501', '4', '#', '', '', '1', '0', 'F', '0', '0', 'monitor:logininfor:unlock',  '#', 103, 1, now(), null, null, '');
-- 在线用户按钮
insert into sys_menu values('1100', '在线查询', '109', '1', '#', '', '', '1', '0', 'F', '0', '0', 'monitor:online:query',       '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1101', '批量强退', '109', '2', '#', '', '', '1', '0', 'F', '0', '0', 'monitor:online:batchLogout', '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1102', '单条强退', '109', '3', '#', '', '', '1', '0', 'F', '0', '0', 'monitor:online:forceLogout', '#', 103, 1, now(), null, null, '');
-- 代码生成按钮
insert into sys_menu values('1120', '生成查询', '112', '1', '#', '', '', '1', '0', 'F', '0', '0', 'tool:gen:query',             '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1121', '生成修改', '112', '2', '#', '', '', '1', '0', 'F', '0', '0', 'tool:gen:edit',              '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1122', '生成删除', '112', '3', '#', '', '', '1', '0', 'F', '0', '0', 'tool:gen:remove',            '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1123', '导入代码', '112', '2', '#', '', '', '1', '0', 'F', '0', '0', 'tool:gen:import',            '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1124', '预览代码', '112', '4', '#', '', '', '1', '0', 'F', '0', '0', 'tool:gen:preview',           '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1125', '生成代码', '112', '5', '#', '', '', '1', '0', 'F', '0', '0', 'tool:gen:code',              '#', 103, 1, now(), null, null, '');
-- oss相关按钮
insert into sys_menu values('1130', '文件查询', '118', '1', '#', '', '', '1', '0', 'F', '0', '0', 'system:oss:query',        '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1131', '文件上传', '118', '2', '#', '', '', '1', '0', 'F', '0', '0', 'system:oss:upload',       '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1132', '文件下载', '118', '3', '#', '', '', '1', '0', 'F', '0', '0', 'system:oss:download',     '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1133', '文件删除', '118', '4', '#', '', '', '1', '0', 'F', '0', '0', 'system:oss:remove',       '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1134', '配置添加', '118', '5', '#', '', '', '1', '0', 'F', '0', '0', 'system:oss:add',          '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1135', '配置编辑', '118', '6', '#', '', '', '1', '0', 'F', '0', '0', 'system:oss:edit',         '#', 103, 1, now(), null, null, '');
-- 租户管理相关按钮
insert into sys_menu values('1606', '租户查询', '113', '1', '#', '', '', '1', '0', 'F', '0', '0', 'system:tenant:query',   '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1607', '租户新增', '113', '2', '#', '', '', '1', '0', 'F', '0', '0', 'system:tenant:add',     '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1608', '租户修改', '113', '3', '#', '', '', '1', '0', 'F', '0', '0', 'system:tenant:edit',    '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1609', '租户删除', '113', '4', '#', '', '', '1', '0', 'F', '0', '0', 'system:tenant:remove',  '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1610', '租户导出', '113', '5', '#', '', '', '1', '0', 'F', '0', '0', 'system:tenant:export',  '#', 103, 1, now(), null, null, '');
-- 租户套餐管理相关按钮
insert into sys_menu values('1611', '租户套餐查询', '114', '1', '#', '', '', '1', '0', 'F', '0', '0', 'system:tenantPackage:query',   '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1612', '租户套餐新增', '114', '2', '#', '', '', '1', '0', 'F', '0', '0', 'system:tenantPackage:add',     '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1613', '租户套餐修改', '114', '3', '#', '', '', '1', '0', 'F', '0', '0', 'system:tenantPackage:edit',    '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1614', '租户套餐删除', '114', '4', '#', '', '', '1', '0', 'F', '0', '0', 'system:tenantPackage:remove',  '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1615', '租户套餐导出', '114', '5', '#', '', '', '1', '0', 'F', '0', '0', 'system:tenantPackage:export',  '#', 103, 1, now(), null, null, '');
-- 流程分类管理
insert into sys_menu values('1140', '分类查询', '121', '1', '#', '', '', '1', '0', 'F', '0', '0', 'workflow:category:query',  '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1141', '分类新增', '121', '2', '#', '', '', '1', '0', 'F', '0', '0', 'workflow:category:add',    '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1142', '分类编辑', '121', '3', '#', '', '', '1', '0', 'F', '0', '0', 'workflow:category:edit',   '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1143', '分类删除', '121', '4', '#', '', '', '1', '0', 'F', '0', '0', 'workflow:category:remove', '#', 103, 1, now(), null, null, '');
-- 表单配置
insert into sys_menu values('1150', '表单查询', '122', '1', '#', '', '', '1', '0', 'F', '0', '0', 'workflow:form:query',   '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1151', '表单新增', '122', '2', '#', '', '', '1', '0', 'F', '0', '0', 'workflow:form:add',     '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1152', '表单修改', '122', '3', '#', '', '', '1', '0', 'F', '0', '0', 'workflow:form:edit',    '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1153', '表单删除', '122', '4', '#', '', '', '1', '0', 'F', '0', '0', 'workflow:form:remove',  '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1154', '表单导出', '122', '5', '#', '', '', '1', '0', 'F', '0', '0', 'workflow:form:export',  '#', 103, 1, now(), null, null, '');
-- 流程模型
insert into sys_menu values('1160', '模型查询', '123', '1', '#', '', '', '1', '0', 'F', '0', '0', 'workflow:model:query',    '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1161', '模型新增', '123', '2', '#', '', '', '1', '0', 'F', '0', '0', 'workflow:model:add',      '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1162', '模型修改', '123', '3', '#', '', '', '1', '0', 'F', '0', '0', 'workflow:model:edit',     '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1163', '模型删除', '123', '4', '#', '', '', '1', '0', 'F', '0', '0', 'workflow:model:remove',   '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1164', '模型导出', '123', '5', '#', '', '', '1', '0', 'F', '0', '0', 'workflow:model:export',   '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1165', '模型导入', '123', '6', '#', '', '', '1', '0', 'F', '0', '0', 'workflow:model:import',   '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1166', '模型设计', '123', '7', '#', '', '', '1', '0', 'F', '0', '0', 'workflow:model:designer', '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1167', '模型保存', '123', '8', '#', '', '', '1', '0', 'F', '0', '0', 'workflow:model:save',     '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1168', '流程部署', '123', '9', '#', '', '', '1', '0', 'F', '0', '0', 'workflow:model:deploy',   '#', 103, 1, now(), null, null, '');
-- 部署管理
insert into sys_menu values('1170', '部署查询', '124', '1', '#', '', '', '1', '0', 'F', '0', '0', 'workflow:deploy:query',   '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1171', '部署删除', '124', '2', '#', '', '', '1', '0', 'F', '0', '0', 'workflow:deploy:remove',  '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1172', '更新状态', '124', '3', '#', '', '', '1', '0', 'F', '0', '0', 'workflow:deploy:status',  '#', 103, 1, now(), null, null, '');
-- 新建流程
insert into sys_menu values('1180', '发起流程',    '125', '1', '#', '', '', '1', '0', 'F', '0', '0', 'workflow:process:start',       '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1181', '新建流程导出', '125', '2', '#', '', '', '1', '0', 'F', '0', '0', 'workflow:process:startExport', '#', 103, 1, now(), null, null, '');
-- 我的流程
insert into sys_menu values('1190', '流程详情',    '126', '1', '#', '', '', '1', '0', 'F', '0', '0', 'workflow:process:query',     '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1191', '流程删除',    '126', '2', '#', '', '', '1', '0', 'F', '0', '0', 'workflow:process:remove',    '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1192', '流程取消',    '126', '3', '#', '', '', '1', '0', 'F', '0', '0', 'workflow:process:cancel',    '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1193', '我的流程导出', '126', '4', '#', '', '', '1', '0', 'F', '0', '0', 'workflow:process:ownExport', '#', 103, 1, now(), null, null, '');
-- 待办任务
insert into sys_menu values('1200', '流程办理',    '127', '1', '#', '', '', '1', '0', 'F', '0', '0', 'workflow:process:approval',   '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1201', '待办流程导出', '127', '2', '#', '', '', '1', '0', 'F', '0', '0', 'workflow:process:todoExport', '#', 103, 1, now(), null, null, '');
-- 待签任务
insert into sys_menu values('1210', '流程签收',    '128', '1', '#', '', '', '1', '0', 'F', '0', '0', 'workflow:process:claim',        '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1211', '待签流程导出', '128', '2', '#', '', '', '1', '0', 'F', '0', '0', 'workflow:process:claimExport',  '#', 103, 1, now(), null, null, '');
-- 已办任务
insert into sys_menu values('1220', '流程撤回',    '129', '1', '#', '', '', '1', '0', 'F', '0', '0', 'workflow:process:revoke',         '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1221', '已办流程导出', '129', '2', '#', '', '', '1', '0', 'F', '0', '0', 'workflow:process:finishedExport', '#', 103, 1, now(), null, null, '');
-- 抄送我的
insert into sys_menu values('1230', '抄送流程导出', '130', '1', '#', '', '', '1', '0', 'F', '0', '0', 'workflow:process:copyExport', '#', 103, 1, now(), null, null, '');
