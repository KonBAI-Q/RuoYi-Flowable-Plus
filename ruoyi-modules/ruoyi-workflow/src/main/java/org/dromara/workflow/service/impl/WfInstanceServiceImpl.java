...
import org.dromara.workflow.domain.vo.WfTaskVo;
import org.dromara.workflow.service.IWfDeployFormService;
import org.dromara.workflow.service.IWfInstanceService;
        ...
        if (StringUtils.isNotBlank(procInsId)) {
            ...
            taskInstanceList.forEach(taskInstance -> {
                ...
                if (StringUtils.isNotBlank(taskInstance.getAssignee())) {
                    SysUserVo user = userService.selectUserById(Long.parseLong(taskInstance.getAssignee()));
